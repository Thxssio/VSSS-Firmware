...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Exemplo de controle PID com Anti-Windup para 2 motores
  ******************************************************************************
  * @attention
  *
  * Copyright (c) 2025.
  ...
  *
  * Este exemplo é fornecido "como está" (AS IS). Ajustes de hardware,
  * pinos, timers, ganhos PID e etc. podem ser necessários conforme seu projeto.
  *
  ******************************************************************************
  */
